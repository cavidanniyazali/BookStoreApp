package com.example.bookstoreapp.config.security.jwt;
...
public class JwtTokenUtil {
    ...
    public Collection<GrantedAuthority> getRolesFromToken(String token) {
        ...
        return (Collection<GrantedAuthority>) claims.get("authorities");
    }
    ...
    public Boolean validateTokenWithRole(String token, UserDetails userDetails, String requiredRole) {
        final String email = getEmailFromToken(token);
